...
class ProductoDetail extends Component{
  ...
  componentDidMount() {    
    ...
    postDestino=()=>{
      ...
      axios.post('http://localhost:3001/destino', destino);
      return false;
    }
    ...
    putDestino=()=>{
      ...
      axios.put('http://localhost:3001/destino/'+this.state.id, destino);
    }

    deleteDestino=()=>{
      axios.delete('http://localhost:3001/destino/'+this.state.id);
      window.location.href = 'http://localhost:3000/DestinoList';
    }
